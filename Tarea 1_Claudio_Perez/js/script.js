...
/**
 * @desc Verifica el elemento que fue paginado en la vista
...
/**
 * @desc LLama una funcion cuando el elemento ha sido paginado en la vista
...
$window.on('load', function () {
	...
	// Carga y transición de la página
